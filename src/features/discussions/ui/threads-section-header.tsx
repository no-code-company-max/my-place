 ...
 *
 * Composición (handoff threads/):
 *  - Chip 56×56 con emoji 💬 (32px) centrado, `bg-surface` border-0.5px,
 *    radius 14.
 *  - Título "Discusiones" en `font-title` 38px tracking tight a la
 *    derecha del chip.
...
export function ThreadsSectionHeader(): React.ReactNode {
  return (
    <header className="flex items-center gap-[18px] px-3 pt-6">
      ...
      <h1 className="flex-1 font-title text-[38px] font-bold leading-tight tracking-[-0.02em] text-text">
        Discusiones
      </h1>
      <Link
