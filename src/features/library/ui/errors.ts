 ...
 * español. Mismo patrón que `events/ui/errors.ts`.
 *
 * Vivía originalmente en `ui/admin/errors.ts` cuando los únicos consumers
 * eran admin/. Movido a la raíz del slice cuando items/ (library-item-form,
 * item-admin-menu) también lo necesitó. Mantener cross-sub-slice via
 * `@/features/library/public` re-export.
 */
